...
peer chaincode invoke -o orderer0.uem.com:7050 --isInit --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n cc2 --peerAddresses $CORE_PEER_ADDRESS --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE -c '{"function":"InitLedger","Args":[]}' --waitForEvent >&log.txt 
cat log.txt