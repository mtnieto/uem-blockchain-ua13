...
peer chaincode query -o orderer0.uem.com:7050  --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n fabcar --peerAddresses $CORE_PEER_ADDRESS --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE  -c '{"Args":["queryCar","CAR1"]}'  >&log.txt 
cat log.txt