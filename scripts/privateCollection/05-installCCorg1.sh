...
export PATHCC=/opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/go/marbles02_private/go
...
peer lifecycle chaincode package chaincode.tar.gz --path $PATHCC --lang golang --label marblesPrivate 
